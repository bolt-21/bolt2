...
export function Clubs() {
  ...
  const handleJoinClub = (club) => {
    ...
    // Super admin and president admin can manage all clubs
    ...
    if (user.role === 'student' || (!user.role && !user.isAdmin)) {
              ...
              filteredClubs.map((club, index) => (
                <motion.div
                  ...
                  <div className="relative">
                    ...
                    {(user?.role === 'super_admin' || user?.role === 'president_admin' || (user?.role === 'club_admin' && user?.assignedClub?.toString() === (club._id || club.id))) && (
                      <div className="absolute top-4 right-4 flex space-x-2">
                        ...
                        {/* Only super admin and president admin can delete clubs */}

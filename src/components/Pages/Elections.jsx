...
export function Elections() {
  ...
  const fetchElections = async () => {
    try {
      ...
      // Check which elections the user has voted in (allow club admins to vote)
  ...
  const handleVote = async (electionId, candidateId) => {
    ...
    // Allow club admins to vote, but block system admins and super admin
    if ((user.isAdmin || user.role === 'admin' || user.role === 'super_admin') && user.role !== 'club_admin') {
      toast.error("System administrators cannot vote in elections");
      return;
    }
              ...
              filteredElections.map((election, index) => (
                <motion.div
                  ...
                  <div className="flex space-x-3">
                    {election.status === "active" && user && ((user.role !== 'admin' && user.role !== 'super_admin') || user.role === 'club_admin') && (
                      <motion.button
